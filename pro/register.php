            ...
            <div class="row">
                ...
                <div class="col-sm-9 col-md-8 col-lg-4 col-xl-4">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="c_name" name="c_name" placeholder="Enter day"
                               required pattern="0?[0-9]|1[0-9]|2[0-9]|3[0-1]">
                    </div>
                </div>
                <div class="d-none d-sm-block col-sm-3 col-md-4 col-lg-2 col-xl-2 mt-auto">
                ...
                <div class="col-sm-9 col-md-8 col-lg-4 col-xl-4 mt-3 mt-lg-0">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="c_name" name="c_name" placeholder="Enter year"
required pattern="19[5-9][0-9]|2[0][0][0]|2[0][0][1]">
                    </div>
                </div>
            </div>
            <div class="row my-3">
